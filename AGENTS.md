...
- Flag jobs that can remain permanently queued after a database write succeeds but enqueueing fails. Prefer a transactional outbox or an explicit recovery mechanism.
